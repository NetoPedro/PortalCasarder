    ...
    render() {
        ...
        if(this.props.bookings !== undefined && !this.props.isLoading) {
            if(this.props.bookings.length){
                ...
                bookingRows = <tr><td colSpan={5}><Translate content="mybookingspage.no_bookings"/></td></tr>;
            }
        } else {
            bookingRows = <tr><td colSpan={5}><ReactLoading type="spin" color="#F3C043" delay={0} className="loading-spin-center-inside"/></td></tr>;
        }

        return (
            <div style={{overflow: "auto", maxHeight: "300px"}}>
                <table className="table table-hover table-responsive-sm table-fixed">
                    <thead>

    ...
    _handleKeyPress = (e) => {
        if (e.key === 'Enter') {
            ...
            this.props.history.push(
                {
                    pathname: '/search',
                    state: {input: this.state.inputValue}
                })
        }
    };
        ...
        return (
            <div className="container d-flex justify-content-center">
                <div className="row main-search-bar">
                    <div className="col-md-10 input-group" style={{paddingLeft: "0", paddingRight: "0", marginBottom: "2%", height: "50px"}}>
                        {/*
                        <Translate
                            component="input"
                            type="text"
...
{/*<div className="btn-group" role="group">
                                <button id="btnGroupDrop1" type="button"
                                        className="btn btn-secondary dropdown-toggle btn-light" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Search for {this.state.searchType}</button>
                                <div className="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                    <button className="dropdown-item" value="name" onClick={st => this.updateSearchType(st)}>Name</button>
                                    <div className="dropdown-divider"/>
                                    <button className="dropdown-item" value="sport" onClick={st => this.updateSearchType(st)}>Sport</button>
                                </div>
                            </div>*/}